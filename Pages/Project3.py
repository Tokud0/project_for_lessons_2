...
class Project3:
    ...
    def plot_bar_chart(self, df, category_column, value_column):
        ...
        if df[category_column].dtype == 'object' or df[category_column].dtype == 'category':
            ...
            st.warning(f"{category_column}if not a categorical column. Please select a categorical column.")
    def app(self):
        ...
        if upload is not None:
            ...
            value_column = st.selectbox("Choose a column for value (numeric)", df.columns)
